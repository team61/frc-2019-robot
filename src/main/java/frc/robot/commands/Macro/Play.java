    ...
    protected void execute() {
        if (scanner.hasNextDouble()) {
            ...
            if (delta <= 0) {
                ...
                // drive motors
                Robot.m_robotbase.moveLeft(scanner.nextDouble());
                Robot.m_robotbase.moveRight(scanner.nextDouble());
                Robot.m_robotbase.moveLiftWheels(scanner.nextDouble());


                // lift motors
                Robot.m_lift.moveLift(scanner.nextDouble());
